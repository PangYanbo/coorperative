...
//				}
				...
				if(tokens[7].equals("5")||tokens[7].equals("6")||tokens[7].equals("7")||tokens[7].equals("8")||tokens[7].equals("9")||tokens[7].equals("10")){
					mode = "vehicle";
				}
				if(tokens[7].equals("11")||tokens[7].equals("12")){
					mode = "train";
				}
				if(tokens[7].equals("97")){
					mode = "stay";
				}
