...
public class ExtractSPbyID {
	
	/*
	 * this class is used for Y! data
	 * stay point is represented in mesh id
	 * prepared for IRL 
	 * 
	 * */
	
	
	public static void main(String[] args) throws NumberFormatException, ParseException, IOException,FileNotFoundException{
        ...
        for (File file : files){  
        	HashMap<String, HashMap<String, ArrayList<STPoint>>> map = SPFinder.intomapY2(file,"all"); 
    		...
    		writeout(trajectory,"/home/t-iho/Data/forIRL/"+"StayPoint"+file.getName());
...
//    		bw2.close();  
	...
	public static HashMap<String, ArrayList<STPoint>> YMap(File in) throws ParseException, NumberFormatException, IOException{
