...
//		UserCheck(id_slot_points);
		...
		Agent.writeout(id_targetList,"/home/t-iho/Sig/agentlist"+dae+".csv");
		...
		writeout(mesh_id_traj,"/home/t-iho/Sig/expData"+date+"inslot.csv");
	...
	public static void SortToMap(File in,HashMap<String,ArrayList<STPoint>>id_points) throws IOException, ParseException{
		...
		while((line=br.readLine())!=null){
			if(GpsProcess.SameLogCheck(line,prevline)==true){
		...
		System.out.println("total user in this area is: "+id_points.size());
	}
