...
//        return map[(y * bins) + x];
//    }
    static double getValue(HashMap<String,Double>map,String key){
    	return map.get(key);
    }

    static Signature getSignature(HashMap<String,Double>map)
    {
...
//        }
        ...
        int i = 0;
        for(String key:map.keySet()){
        	double val = getValue(map,key);
        	if(val>0){
        		Feature2D f = new Feature2D(key);
            	features[i] = f;
            	weights[i] = val;
            	i++;	
        	}
...
//        }
    ...
    static double emdDist(HashMap<String,Double>map1, HashMap<String,Double>map2)
    {
...
//    	HashMap<String,Double>a0 = new HashMap<String,Double>();
...
//    	a1.put("53394614", 0.0);
        ...
        System.out.println("test 1: " + emdDist(gps, agent) + " at hour"+hour);
//        System.out.println("test 1: " + emdDist(a0, a1) + " [expected: 1.0]");
//        System.out.println("test 2: " + emdDist(a0, a2) + " [expected: 2.0]");
//        System.out.println("test 3: " + emdDist(b0, b1) + " [expected: 19.1921]");
//        System.out.println("test 4: " + emdDist(b0, b2) + " [expected: 25.7637]");
		}
    }
}
