 ...
 * */
	...
	public static void main(String[] args) throws IOException, ParseException{
		...
		File in = new File("");
		File out = new File("C:/Users/PangYanbo/Desktop/UbiResult/simtest.csv");
		...
		BufferedReader br = new BufferedReader(new FileReader("C:/Users/PangYanbo/Desktop/UbiResult/PTSample.csv"));
		...
		long currentDate = SDF_TS2.parse("2017-06-12 06:00:00").getTime();
		
		Network network = (new NetworkLoader()).load(new File("D:/drmbaseroad.csv"));
		Network railnet = (new NetworkLoader()).loadrail(new File("D:/railnetwork.csv"));
...
//			}
			...
			try{
				if(!id.equals(previd)){
					currentDate = SDF_TS2.parse("2017-06-12 06:00:00").getTime()+random.nextInt(1800000);
				}
...
//						System.out.println(j);
					...
					if(mode.equals("stay")){
						while(currentDate<SDF_TS2.parse("2017-06-12 06:00:00").getTime()+(slot-12)*1800000){
							currentDate = SDF_TS2.parse("2017-06-12 06:00:00").getTime()+(slot-12)*1800000 + random.nextInt(1800*1000);
						}
					...
					if(mode.equals("vehicle")){
						...
						if(route==null){
							...
							currentDate += currentDate += source.distance(target)*1000/11.1;
...
//			}
		...
		BufferedWriter bw2 = new BufferedWriter(new FileWriter("D:/training data/pflowLinkVolume.csv"));
...
//			System.out.println(mesh_node.get(mesh));
	...
	protected static final SimpleDateFormat SDF_TS3 = new SimpleDateFormat("yyyy-MM-dd");
}
